...
func init() {
	C.fg_init_platform_method_handle_{{.ID}}((C.FgPlatformMethodHandle)(C.fg_platform_method_handle))
...
func initPlatformMethodHandle(handle func(method int32, data []byte) ([]byte, error)) {
