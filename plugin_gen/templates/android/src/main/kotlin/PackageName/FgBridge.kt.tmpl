...
private class Bridge : FgBridge() {
    companion object {
        ...
        init {
            ...
            bridgeLib.fg_init_platform_method_handle_{{.ID}}(methodHandle)
        }
        ...
        fun callGoMethod(method: Int, data: ByteArray?): Result<ByteArray?> {
            ...
            val response = bridgeLib.fg_call_go_method_{{.ID}}(request)
        ...
        fun callDartMethod(method: Int, data: ByteArray?) {
            ...
            bridgeLib.fg_call_dart_method_{{.ID}}(request)
        }
...
private interface BridgeLib : Library {
    fun fg_init_platform_method_handle_{{.ID}}(handle: FgPlatformMethodHandleCallback)
    fun fg_call_dart_method_{{.ID}}(request: FgRequest.ByValue)
    fun fg_call_go_method_{{.ID}}(request: FgRequest.ByValue): FgResponse.ByValue
}
